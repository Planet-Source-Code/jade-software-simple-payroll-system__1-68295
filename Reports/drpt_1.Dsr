VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} RptPayroll 
   Caption         =   "Payroll Report"
   ClientHeight    =   8484
   ClientLeft      =   288
   ClientTop       =   348
   ClientWidth     =   11880
   Icon            =   "drpt_1.dsx":0000
   MDIChild        =   -1  'True
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item3 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "          Southernside Montessori School"
         Alignment       =   2
      EndProperty
      ItemType4       =   3
